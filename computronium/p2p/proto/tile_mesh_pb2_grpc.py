...
from computronium.p2p.proto import tile_mesh_pb2 as computronium_dot_p2p_dot_proto_dot_tile__mesh__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in computronium/p2p/proto/tile_mesh_pb2_grpc.py depends on'
...
class TileMeshService:
    ...
    def FetchTileActivation(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/bioplausible.p2p.TileMeshService/FetchTileActivation',
            computronium_dot_p2p_dot_proto_dot_tile__mesh__pb2.TileActivationRequest.SerializeToString,
            computronium_dot_p2p_dot_proto_dot_tile__mesh__pb2.TileActivationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SyncBoundaryTiles(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/bioplausible.p2p.TileMeshService/SyncBoundaryTiles',
            computronium_dot_p2p_dot_proto_dot_tile__mesh__pb2.BoundarySyncRequest.SerializeToString,
            computronium_dot_p2p_dot_proto_dot_tile__mesh__pb2.BoundarySyncResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Heartbeat(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/bioplausible.p2p.TileMeshService/Heartbeat',
            computronium_dot_p2p_dot_proto_dot_tile__mesh__pb2.HeartbeatRequest.SerializeToString,
            computronium_dot_p2p_dot_proto_dot_tile__mesh__pb2.HeartbeatResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def PushParameterUpdate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/bioplausible.p2p.TileMeshService/PushParameterUpdate',
            computronium_dot_p2p_dot_proto_dot_tile__mesh__pb2.ParameterUpdateRequest.SerializeToString,
            computronium_dot_p2p_dot_proto_dot_tile__mesh__pb2.ParameterUpdateResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ExecuteStep(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/bioplausible.p2p.TileMeshService/ExecuteStep',
            computronium_dot_p2p_dot_proto_dot_tile__mesh__pb2.ExecuteStepRequest.SerializeToString,
            computronium_dot_p2p_dot_proto_dot_tile__mesh__pb2.ExecuteStepResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
