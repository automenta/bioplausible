...
Usage:
    python -m computronium.analysis.results_cli rank --db path/to/study.db
"""

import argparse

from computronium.analysis.results import get_rankings, load_trials, print_rankings
...
def main():
    ...
    rank_parser.add_argument(
        "--db", default=db_path("computronium.db"), help="Path to database"
    )
