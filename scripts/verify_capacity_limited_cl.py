...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--protocol", default="task_incremental", choices=["task_incremental", "task_free"])
    parser.add_argument(
    ...
    print(f"Running capacity-limited CL probe: hidden_dim={args.hidden_dim}, epochs={args.epochs}, seeds={args.seeds}")
    print(f"Arms: {arms}")
    ...
    for arm, proto_results in results.items():
        for proto, res in proto_results.items():
            ...
            print(f"{arm:<15} {mean_forgetting:>15.4f} {mean_bwt:>10.4f} {mean_fwt:>10.4f}")
            summary[arm] = {
