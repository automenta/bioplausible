...
```
eqprop_torch/                    # Main library package
...
eqprop_trainer/                  # Dashboard application
...
### eqprop_torch Package ✅
- [x] All code in package directory
- [x] Tests in `eqprop_torch/tests/`
...
cp -r eqprop_torch/ eqprop-torch-repo/
...
cp -r eqprop_trainer/ eqprop-trainer-repo/
