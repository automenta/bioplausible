...
5. **App Documentation** (bioplausible_ui/README.md)
...
|-----------|---------|-------|----------|
| **bioplausible** | 9 | ~1800 | 4 core models + 5 LM variants |
| **bioplausible_ui** | 6 | ~900 | Dual-tab UI with live plots |
...
```
eqprop/
├── bioplausible/          # Library (9 modules, ~1800 lines)
...
│   └── README.md
│
├── bioplausible_ui/        # Dashboard App (6 files)
│   ├── main.py
