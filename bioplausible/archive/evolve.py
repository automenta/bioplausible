...
def parse_args():
    ...
    parser.add_argument(
        "--generations", "-g", type=int, default=20, help="Number of generations"
    )
    parser.add_argument(
        "--population", "-p", type=int, default=20, help="Population size"
    )
    parser.add_argument(
        "--mutation-rate", "-m", type=float, default=0.3, help="Mutation rate (0-1)"
    )
    parser.add_argument(
        "--crossover-rate", "-c", type=float, default=0.7, help="Crossover rate (0-1)"
    )
    parser.add_argument(
        "--elite-fraction",
        "-e",
    ...
    # Time limits
    parser.add_argument(
        "--hours", type=float, default=24.0, help="Maximum runtime in hours"
    )
    ...
    parser.add_argument(
        "--dry-run", action="store_true", help="Print configuration and exit"
    )
