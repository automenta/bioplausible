...
class EquilibriumDemo(QWidget):
    ...
    def train_model(self):
        ...
        self.status_label.setText(
            f"✓ Training complete! Accuracy: {acc*100:.1f}%. Now click 'Run Convergence'"
        )
        self.status_label.setStyleSheet(
            "color: #27ae60; padding: 5px; font-weight: bold;"
        )
    ...
    def run_convergence(self):
        ...
        # Get a test digit
        self.digit_img, self.digit_label = get_single_digit(
        ...
        with torch.no_grad():
            _, trajectory = self.model.forward(
                self.digit_img, steps=30, return_trajectory=True
            )
