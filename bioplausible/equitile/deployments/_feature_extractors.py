"""Shared feature extractors and graph utilities for EquiTile deployments.

These modules back the vision, time-series, RL, and graph deployment models.
They are intentionally implementation details (private module); the public
deployment modules re-export the symbols they need via ``__all__``.
"""
...
class RLFeatureExtractor(nn.Module):
    ...
    def get_config(self) -> EquiTileConfig:
        ...
        return self.equitile.get_config()
