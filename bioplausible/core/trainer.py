...
def dispatch_train_step(
    ...
    if (
        ...
        if bespoke_step is not None:
            ...
            from bioplausible.core.trainer import _run_contrastive_kernel_step
            ...
            from bioplausible.core.trainer import _run_kernel_train_step
    ...
    from bioplausible.core.ebm import EnergyModel
