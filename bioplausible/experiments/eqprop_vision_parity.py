...
Usage:
    python -m bioplausible.experiments.eqprop_vision_parity --tasks mnist,fashion_mnist,cifar10,svhn --seeds 5
"""
...
from bioplausible.analysis.dynamics import DynamicsAnalyzer
from bioplausible.cli.run import _BASELINE_MODELS
