...
Usage:
    python -m bioplausible.experiments.tile_scaling --tasks mnist,cifar10 --algorithms all --depths 2,4,6,8,10,12 --widths 32,64,128,256 --seeds 3
"""
...
from bioplausible.analysis.pareto import ParetoFrontier, compute_pareto_frontier
from bioplausible.analysis.scaling import ScalingLawFitter, fit_power_law
