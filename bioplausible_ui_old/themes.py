...
DARK_THEME_COLORS = BASE_COLORS['dark']
LIGHT_THEME_COLORS = BASE_COLORS['light']
NORD_THEME_COLORS = BASE_COLORS['nord']
SOLARIZED_THEME_COLORS = BASE_COLORS['solarized']
CYBERPUNK_THEME_COLORS = DARK_THEME_COLORS  # Cyberpunk is essentially dark theme
...
# Theme definitions
CYBERPUNK_DARK = create_theme(BASE_COLORS['dark'])
LIGHT_THEME = create_theme(BASE_COLORS['light'])
NORD_THEME = create_theme(BASE_COLORS['nord'])
SOLARIZED_THEME = create_theme(BASE_COLORS['solarized'])

# Neon glow colors for plots - Dark theme default, but can be used in Light too
PLOT_COLORS = create_plot_colors(BASE_COLORS['dark'])
LIGHT_PLOT_COLORS = create_plot_colors(BASE_COLORS['light'])
NORD_PLOT_COLORS = create_plot_colors(BASE_COLORS['nord'])
CYBERPUNK_PLOT_COLORS = create_plot_colors(BASE_COLORS['dark'])  # Same as dark
SOLARIZED_PLOT_COLORS = create_plot_colors(BASE_COLORS['solarized'])
...
THEME_REGISTRY = {
    ...
    'solarized': {
        'ui': BASE_COLORS['solarized'],
        'theme_css': SOLARIZED_THEME,
